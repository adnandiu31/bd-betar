                                ...
                                <td class="text-center">
                                    @if($indent->approved_by_dg_at )
                                        <a class="btn btn-info btn-sm"
                                           href="{{ route('DSE.indents.report1',$indent->manufacture_id) }}"><i
                                    ...
                                    @if($indent->approved_by_dg_at )
                                        <a class="btn btn-info btn-sm"
                                           href="{{ route('DSE.indents.pdf',$indent->manufacture_id) }}"><i
                                                class="mdi mdi-download"></i>
                                            <span>Download</span>
                                        </a>
                                    @else
                                    ...
                                    @endisset
                                        ...
                                        <a class="btn btn-info btn-sm"
                                           href="{{ route('DSE.indents.stationwise.quantity',$indent->manufacture_id) }}"><i
                                                class="mdi mdi-download"></i>
                                            <span>Stationwise Qt</span>
                                        </a>
                                   
                        
                                    <a class="btn btn-info btn-sm"
                                       href="{{ route('DSE.indents.partList',$indent->id) }}"><i
                                            class="mdi mdi-eye"></i>
                                        <span>Show</span>
                                    </a>
                                </td>
