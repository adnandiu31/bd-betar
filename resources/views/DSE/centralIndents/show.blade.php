        ...
        <div class="navbar-menu-wrapper d-flex flex-grow">
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item mr-2">
                    <form method="post" action="{{ route('DSE.indents.statusChange',$indent->id) }}">
                        @csrf
                ...
                <li class="nav-item">
                    <a href="{{ route('DSE.indents.manufactureList') }}" class="btn-shadow btn btn-danger">
                                    ...
                                    <table id="datatable" class="align-middle mb-0 table table-borderless table-hover">
                                        ...
                                        <th class="text-center">
                                            <div class="d-flex justify-content-around">
                                                <span class="mr-4">Requisition</span>
                                            ...
                                            @foreach($partLists as $key=>$indent)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <form id="updatePart-{{$indent->id}}" action="{{route('DSE.indents.requisitionUpdate',['part_id'=>$indent->part_id,'central_indent_id'=>$indent->central_indent_id])}}" method="POST">
                                                            @csrf
                                                            <div class="d-flex justify-content-around">
                                                                <input name="requisition" type="number" class="form-control mr-4" value="{{$indent->remaining}}">
                                                                <input name="unit_price" type="number" class="form-control" value="{{$indent->unit_price}}"> 
                                                            </div>
                                                        </form>
                                                    </td>
                                                    <td>
