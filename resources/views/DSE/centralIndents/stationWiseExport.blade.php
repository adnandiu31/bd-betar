...
<div class="table_area">
    <table>
        ...
        @foreach ($details as $key => $indent)
            @php
                $totalSum += $indent->remaining * $indent->unit_price;
            @endphp
            <tr>
        ...
        <tr>
            ...
            <td class="text-center text-muted">{{$totalSum}}</td>
