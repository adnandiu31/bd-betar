        ...
        <div class="navbar-menu-wrapper d-flex flex-grow">
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item mr-2">
                    <form method="post" action="{{ route('SE.indents.statusChange',$indent->id) }}">
                        @csrf
                ...
                <li class="nav-item mr-2">
                    <form method="post" action="{{ route('SE.indents.approved',$indent->id) }}">
                        @csrf
                        <button type="submit" class="btn {{ $indent->approved_by_se_at ? 'btn-success': 'btn-danger' }}">
                            Mark as {{ $indent->approved_by_se_at  ? 'Pending' : 'Approved' }}
                        </button>
                    </form>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('SE.indents.manufactureList') }}" class="btn-shadow btn btn-danger">
