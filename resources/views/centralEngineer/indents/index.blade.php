    ...
    <div class="row">
        <div class="col-md-12 ">
            <div class="bg-white mx-1 my-4 px-5 py-2 rounded">
               <form action="{{route('centralEngineer.indents.index')}}" method="get">
                    <div class=" d-flex justify-content-around align-items-center py-2 ">
                        ...
                        <div class="">
                            <div class="d-flex">
                                ...
                                <div>
                                    <a href="{{route('centralEngineer.indents.index')}}" class="btn btn-warning btn-sm  py-2 ml-2"> Reset</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <td class="text-center">
                                    @if ($indent->isApproved())
                                        <a class="btn btn-info btn-sm"
                                           href="{{ route('centralEngineer.indents.export',$indent->id) }}"><i
                                                class="mdi mdi-download"></i>
                                            <span>Download</span>
                                        </a>
                                    @endif
                                    <a class="btn btn-info btn-sm"
                                       href="{{ route('centralEngineer.indents.show',$indent->id) }}"><i
                                            class="mdi mdi-eye"></i>
                                        <span>Show</span>
                                    </a>
                                </td>
