                ...
                <div class="table-responsive">
                    <table id="datatable" class="align-middle mb-0 table table-borderless table-hover">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Final Approval Status</th>
                                ...
                                <td class="text-center">    
                                    @if($indent->approved_by_dg_at )
                                        <a class="btn btn-info btn-sm"
                                           href="{{ route('directorGeneral.indents.pdf',$indent->manufacture_id) }}"><i
                                    ...
                                    <a class="btn btn-info btn-sm"
                                       href="{{ route('directorGeneral.indents.partList',$indent->id) }}"><i
                                            class="mdi mdi-eye"></i>
                                        <span>Show</span>
                                    </a>
                                </td>
