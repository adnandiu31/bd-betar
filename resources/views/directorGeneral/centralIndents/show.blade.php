    ...
    <div class="navbar-bottom">
        ...
        <div class="navbar-menu-wrapper d-flex flex-grow">
            <ul class="navbar-nav navbar-nav-right">
                ...
                @if ($indent->approved_by_ce_at ==!null)
                    <li class="nav-item mr-2">
                        <form method="post" action="{{ route('directorGeneral.indents.approved',$indent->id) }}">
                            @csrf
                            <button type="submit" class="btn {{ $indent->approved_by_dg_at ? 'btn-success' : 'btn-danger' }}">
                                Mark as {{ $indent->approved_by_dg_at  ? 'Pending' : 'Approved' }}
                            </button>
                        </form>
                    </li>
                @endif
                <li class="nav-item">
                    <a href="{{ route('directorGeneral.indents.manufactureList') }}" class="btn-shadow btn btn-danger">
