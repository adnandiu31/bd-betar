    ...
    <div class="navbar-bottom">
        ...
        <div class="navbar-menu-wrapper d-flex flex-grow">
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item">
                    <a href="{{ route('directorGeneral.indents.index') }}" class="btn-shadow btn btn-danger">
                                    ...
                                    <table id="datatable" class="align-middle mb-0 table table-borderless table-hover">
                                        ...
                                        @foreach($indent->parts as $key=>$indentPart)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $indentPart->part->manufacture->name ?? null }}</td>
                                                <td class="text-center">{{ $indentPart->quantity ?? 0 }}</td>
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-danger btn-sm"
