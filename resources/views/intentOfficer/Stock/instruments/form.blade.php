    ...
    <div class="navbar-bottom">
        ...
        <div class="navbar-menu-wrapper d-flex flex-grow">
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item">
                    <a href="{{ route('stock.instruments.index') }}" class="btn-shadow btn btn-danger">
        ...
        <div class="col-sm-12 col-md-8 mx-auto">
            <div class="card">
                <div class="card-body">
                    <!-- form start -->
                    <form method="POST"
                          action="{{ isset($stockInstrument) ?  route('stock.instruments.update',$stockInstrument->id) : route('stock.instruments.store') }}"
