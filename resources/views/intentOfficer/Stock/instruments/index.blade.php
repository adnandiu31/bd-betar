      ...
      <div class="row">
        <div class="col-md-12 ">
            ...
            <div class="bg-white mx-1 my-4 px-5 py-2 rounded">
               <form action="{{route('intentOfficer.stock.instruments')}}" method="get">
                    <div class=" d-flex justify-content-around align-items-center py-2 ">
                        ...
                        <div class="">
                            <div class="d-flex">
                                ...
                                <div>
                                    <a href="{{route('intentOfficer.stock.instruments')}}" class="btn btn-warning btn-sm  py-2 ml-2"> Reset</a>
                                </div>
                            </div>
                        </div>
                    </div>
