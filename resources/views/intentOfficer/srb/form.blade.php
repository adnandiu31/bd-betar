...
{{--                </li>--}}
                <li class="nav-item">
                    <a href="{{ route('intentOfficer.srb.index') }}" class="btn-shadow btn btn-danger">
...
{{--                                @endif--}}
                            ...
                            <tbody>
                            @foreach($srb->indent->parts as $key=>$srbPart)
                                <tr>
                                    <td class="text-center text-muted">{{ $key + 1 }}</td>
...
{{--                                    @else--}}
{{--                                        <td class="text-center">--}}
{{--                                            <form id="updatePart-{{$srbPart->id}}" action="{{route('storekeeper.srb.instrument.store',['srb'=>$srb->id,'part'=>$srbPart->id])}}" method="POST">--}}
{{--                                                @csrf--}}
