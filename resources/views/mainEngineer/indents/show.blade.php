        ...
        <div class="navbar-menu-wrapper d-flex flex-grow">
            <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item mr-2">
                    <form method="post" action="{{ route('mainEngineer.indents.approved.forCentral',$indent->id) }}">
                        @csrf
                        <button type="submit" class="btn {{ $indent->approved_for_cen_ind ? 'btn-success': 'btn-danger' }}">
                            Mark for {{ $indent->approved_for_cen_ind  ? 'Central Indent Generate' : ' Not Central Indent Generate' }}
                        </button>
                    </form>
                </li>
                
                <li class="nav-item">
                    <a href="{{ route('mainEngineer.indents.index') }}" class="btn-shadow btn btn-danger">
                                    ...
                                    <table id="datatable" class="align-middle mb-0 table table-borderless table-hover">
                                        ...
                                        @foreach($indent->instruments as $key=>$indentInstrument)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $indentInstrument->quantity }}</td>
