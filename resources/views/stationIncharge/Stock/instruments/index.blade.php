    ...
    <div class="row">
        <div class="col-md-12 ">
            ...
            <div class="bg-white mx-1 my-4 px-5 py-2 rounded">
               <form action="{{route('stationIncharge.stock.instruments')}}" method="get">
                    <div class=" d-flex justify-content-around align-items-center py-2 ">
                        ...
                        <div class="">
                            <div class="d-flex">
                                ...
                                <div>
                                    <a href="{{route('stationIncharge.stock.instruments')}}" class="btn btn-warning btn-sm  py-2 ml-2"> Reset</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="align-middle mb-0 table table-borderless table-hover">
                        ...
                        @foreach($stockInstruments as $key=>$stockInstrument)
                            <tr>
                                ...
                                <td class="text-center">{{ $stockInstrument->instrument->instrument_id ?? null }}</td>
                                <td class="text-center">{{ $stockInstrument->instrument->name ?? null }}</td>
                                <td class="text-center">{{ $stockInstrument->instrument->instrumentType->name ?? null }}</td>
                                <td class="text-center">{{ $stockInstrument->instrument->manufacture->name ?? null }}</td>
