                    ...
                    <table id="datatable" class="align-middle mb-0 table table-borderless table-hover">
                        ...
                        {{-- @foreach($parts as $key=>$instrument)
                            <tr>
                                ...
                                <td class="text-center">{{ $instrument->stockInstrument->instrument->name }}</td>
                                <td class="text-center">{{ $instrument->designation }}</td>
                                <td class="text-center">{{ $instrument->part_no }}</td>
                                <td class="text-center">{{ $instrument->part_pos }}</td>
                                <td class="text-center">{{ $instrument->ledger_info }}</td>
                                <td class="text-center">{{ $instrument->usage_name }}</td>
                                ...
                                <form id="delete-form-{{$instrument->id }}"
                                    action="{{ route('storekeeper.sib.part.deleteInstruments',$instrument->id) }}" method="POST"
                                    style="display: none;">
                                    @csrf()
                                    @method('DELETE')
                                </form>
